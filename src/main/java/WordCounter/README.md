...
It looks for the file in the current directory and its subdirectories and in case there are multiple files with the same name but different paths, it issues a warning message and selects the most recent one.
